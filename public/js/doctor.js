...
const predefinedAdvices = [
  { id: 1, text: "দ্রুত পরীক্ষা করাবেন, রিপোর্ট আপলোড করবেন বা দেখাবেন।" },
  { id: 2, text: "পাতে কাঁচা লবণ খাবেন না।" },
  { id: 3, text: "প্রতিদিন অন্তত ২০ থেকে ৩০ মিনিট নিয়মিত হাঁটবেন।" },
  { id: 4, text: "আপততঃ কোনো ভারী জিনিস তুলবেন না বা ভারী কাজ করবেন না।" },
  { id: 5, text: "তৈলাক্ত, চর্বিজাতীয় এবং ভাজাপোড়া খাবার খাওয়া পুরোপুরি বন্ধ করুন।" },
  { id: 6, text: "প্রতিদিন পর্যাপ্ত পরিমাণে (কমপক্ষে ৮-১০ গ্লাস) নিরাপদ পানি পান করবেন।" },
  { id: 7, text: "রাতে ঘুমানোর অন্তত দুই ঘণ্টা আগে রাতের খাবার শেষ করবেন।" },
  { id: 8, text: "দৈনিক ৭ থেকে ৮ ঘণ্টা নিবিড়ভাবে ঘুমানোর চেষ্টা করুন।" },
  { id: 9, text: "খাবারে চিনির পরিমাণ কমিয়ে দিন এবং মিষ্টিজাতীয় খাবার পরিহার করুন।" },
  { id: 10, text: "চা বা কফিতে অতিরিক্ত চিনি খাওয়া বন্ধ করুন এবং দৈনিক পানের পরিমাণ সীমিত করুন।" },
  { id: 11, text: "ধূমপান, জর্দা বা যেকোনো ধরণের তামাকজাতীয় দ্রব্য বর্জন করুন।" },
  { id: 12, text: "অতিরিক্ত মানসিক চাপ বা দুশ্চিন্তা থেকে দূরে থাকার চেষ্টা করুন।" },
  { id: 13, text: "যেকোনো ওষুধ ডাক্তারের পরামর্শ ছাড়া হঠাৎ করে বন্ধ করবেন না বা ডোজ বদলাবেন না।" },
  { id: 14, text: "অ্যান্টিবায়োটিক সেবনের ক্ষেত্রে অবশ্যই পুরো কোর্স সম্পূর্ণ করবেন।" },
  { id: 15, text: "প্রতিদিনের খাদ্যতালিকায় পর্যাপ্ত পরিমাণে সবুজ শাকসবজি এবং তাজা ফলমূল রাখুন।" },
  { id: 16, text: "ফাস্টফুড, কোমল পানীয় (soft drinks) এবং প্রক্রিয়াজাত খাবার (processed food) এড়িয়ে চলুন।" },
  { id: 17, text: "ডায়াবেটিস বা প্রেসার থাকলে নিয়মিত বিরতিতে তা ঘরে বা ফার্মেসিতে মেপে নোট করে রাখুন।" },
  { id: 18, text: "দীর্ঘ সময় এক জায়গায় টানা বসে না থেকে মাঝে মাঝে একটু উঠে দাঁড়ান বা হাঁটাহাঁটি করুন।" },
  { id: 19, text: "খাবারের ঠিক পরপরই সাথে সাথে শুয়ে পড়বেন না।" },
  { id: 20, text: "ব্যথানাশক ওষুধ (painkiller) খালি পেটে বা ডাক্তারের পরামর্শ ছাড়া খাবেন না।" },
  { id: 21, text: "ওজন নিয়ন্ত্রণে রাখুন এবং উচ্চতা অনুযায়ী আদর্শ ওজন বজায় রাখার চেষ্টা করুন।" },
  { id: 22, text: "কৃত্রিম উপায়ে তৈরি জুস বা ক্যানজাত খাবারের চেয়ে সরাসরি ফল চিবিয়ে খাওয়ার অভ্যাস করুন।" },
  { id: 23, text: "খাবারে অতিরিক্ত মসলা এবং ঝাল পরিহার করে চলুন।" },
  { id: 24, text: "যেকোনো নতুন শারীরিক উপসর্গ দেখা দিলে নিজে নিজে ওষুধ না কিনে রেজিস্টার্ড চিকিৎসকের শরণাপন্ন হোন।" },
  { id: 25, text: "বাইরের খোলা বা বাসি খাবার খাওয়া থেকে বিরত থাকুন।" },
  { id: 26, text: "প্রেসার, ডায়াবেটিস বা হার্টের রোগীরা নির্দিষ্ট সময় পর পর রুটিন চেকআপের জন্য ডাক্তারের কাছে আসবেন।" },
  { id: 27, text: "নিয়মিত দাঁত ব্রাশ করুন এবং মুখের স্বাস্থ্য বজায় রাখুন।" },
  { id: 28, text: "বাইরে বের হওয়ার সময় মাস্ক ব্যবহার করুন এবং ধুলোবালি এড়িয়ে চলুন।" },
  { id: 29, text: "প্রস্রাব দীর্ঘক্ষণ আটকে রাখবেন না, পর্যাপ্ত বেগ হলে সাথে সাথে প্রস্রাব করুন।" },
  { id: 30, text: "প্রসূতি মায়েরা নিয়মিত গর্ভকালীন স্বাস্থ্য পরীক্ষা (ANC) করাবেন।" },
  { id: 31, text: "শিশুদের সময়মতো সকল টিকা নিশ্চিত করুন।" },
  { id: 32, text: "কাশির সময় মুখে রুমাল বা কনুই ব্যবহার করুন।" },
  { id: 33, text: "খাবার খাওয়ার আগে এবং টয়লেট ব্যবহারের পরে সাবান দিয়ে ভালো করে হাত ধুয়ে নিন।" }
];
