...
const predefinedAdvices = [
  // 1. Diagnostics & Follow-ups
  { id: 1, text: "দ্রুত পরীক্ষা করাবেন এবং পরীক্ষার রিপোর্ট নিয়ে পরবর্তী পরামর্শের জন্য যোগাযোগ করবেন।" },
  { id: 2, text: "দীর্ঘস্থায়ী রোগীরা (উচ্চ রক্তচাপ, ডায়াবেটিস, থাইরয়েড ও হার্টের রোগী) নিয়মিত চিকিৎসকের ফলোআপে থাকবেন।" },
  { id: 3, text: "যেকোনো জরুরি শারীরিক জটিলতায় অবহেলা না করে নিকটস্থ হাসপাতালে বা জরুরি বিভাগে যোগাযোগ করুন।" },
  
  // 2. Cardiovascular & Hypertension (BP)
  { id: 4, text: "পাতে অতিরিক্ত কাঁচা লবণ খাওয়া সম্পূর্ণরূপে বন্ধ করুন।" },
  { id: 5, text: "প্রতিদিন অন্তত ৩০ মিনিট মাঝারি গতিতে নিয়মিত হাঁটবেন (সপ্তাহে কমপক্ষে ১৫০ মিনিট)।" },
  { id: 6, text: "রক্তচাপ (BP) নিয়মিত মেপে ডায়রিতে তারিখ ও সময়সহ নোট করে রাখবেন।" },
  { id: 7, text: "কিডনি সুরক্ষায় ব্যথানাশক ওষুধ এবং অতিরিক্ত প্রোটিন/লবণ খাওয়া থেকে বিরত থাকুন।" },
  
  // 3. Diabetes & Metabolism
  { id: 8, text: "খাবারে চিনির পরিমাণ কমিয়ে দিন এবং মিষ্টি, কোমল পানীয় ও ক্যানজাত খাবার পরিহার করুন।" },
  { id: 9, text: "ডায়াবেটিস (Blood Glucose) নিয়মিত খালি পেটে এবং খাওয়ার ২ ঘণ্টা পর মেপে ডায়রিতে নোট করে রাখবেন।" },
  { id: 10, text: "ওজন নিয়ন্ত্রণে রাখুন এবং উচ্চতা অনুযায়ী আদর্শ ওজন বজায় রাখার চেষ্টা করুন।" },
  { id: 11, text: "হাড় ও জয়েন্টের সুস্থতায় প্রতিদিন সকালে কিছু সময় গায়ে রোদ লাগান (ভিটামিন-ডি এর জন্য)।" },
  
  // 4. Gastrointestinal & Diet (Acidity, Gastric)
  { id: 12, text: "তৈলাক্ত, চর্বিজাতীয়, ভাজাপোড়া এবং অতিরিক্ত মসলাযুক্ত খাবার খাওয়া পরিহার করুন।" },
  { id: 13, text: "খাবারের নির্দিষ্ট সময়সূচী মেনে চলুন এবং কোনো বেলার খাবার (বিশেষ করে সকালের নাস্তা) বাদ দেবেন না।" },
  { id: 14, text: "রাতে ঘুমানোর অন্তত ২ ঘণ্টা আগে রাতের খাবার শেষ করার অভ্যাস করুন।" },
  { id: 15, text: "খাবারের ঠিক পরপরই শুয়ে পড়বেন না, অন্তত ২০-৩০ মিনিট সোজা থাকুন বা হালকা হাঁটুন।" },
  { id: 16, text: "বাইরের খোলা, বাসি, অপরিষ্কার বা রাস্তার ধারের খাবার খাওয়া থেকে সম্পূর্ণ বিরত থাকুন।" },
  { id: 17, text: "প্রতিদিন কমপক্ষে ২.৫ থেকে ৩ লিটার (৮-১০ গ্লাস) নিরাপদ ও বিশুদ্ধ পানি পান করবেন।" },
  
  // 5. Medication Safety & Instructions
  { id: 18, text: "ডাক্তারের পরামর্শ ছাড়া কোনো ওষুধ হঠাৎ করে বন্ধ করবেন না বা ডোজ পরিবর্তন করবেন না।" },
  { id: 19, text: "অ্যান্টিবায়োটিক প্রেসক্রিপশন অনুযায়ী নির্দিষ্ট সময়ে খাবেন এবং কোর্স অবশ্যই সম্পূর্ণ করবেন।" },
  { id: 20, text: "ব্যথানাশক ওষুধ (Painkiller) খালি পেটে অথবা ডাক্তারের পরামর্শ ছাড়া সেবন করবেন না।" },
  { id: 21, text: "শ্বাসকষ্ট বা হাঁপানির রোগীরা ইনহেলার ব্যবহারের পর অবশ্যই মুখ ভালো করে কুলি করে ধুয়ে নিবেন।" },
  { id: 22, text: "ডাক্তারের পরামর্শ ছাড়া কোনো ধরণের কবিরাজি, ভেষজ, homeopathy বা টোটকা চিকিৎসা নেবেন না।" },
  
  // 6. Rest, Lifestyle & Stress
  { id: 23, text: "প্রতিদিন রাতে ৭ থেকে ৮ ঘণ্টা পর্যাপ্ত ও নিবিড়ভাবে ঘুমানোর চেষ্টা করুন।" },
  { id: 24, text: "ধূমপান, জর্দা, গুল, পান বা যেকোনো ধরণের তামাকজাতীয় দ্রব্য সম্পূর্ণরূপে বর্জন করুন।" },
  { id: 25, text: "মানসিক চাপ মুক্ত থাকার চেষ্টা করুন এবং প্রয়োজনে শ্বাস-প্রশ্বাসের ব্যায়াম (Deep breathing) করুন।" },
  { id: 26, text: "দীর্ঘ সময় একনাগাড়ে বসে বা দাঁড়িয়ে না থেকে প্রতি ৩০-৪০ মিনিট পর পর অবস্থান পরিবর্তন করুন।" },
  { id: 27, text: "আপততঃ কোনো ভারী জিনিস তুলবেন না বা কোমর বাঁকা করে কোনো কাজ করবেন না।" },
  
  // 7. General Infections, Hygiene & Special Conditions
  { id: 28, text: "জ্বর, সর্দি ও কাশির সময় হালকা কুসুম গরম পানি পান করুন এবং কুসুম গরম লবণ-পানি দিয়ে গড়গড়া করুন।" },
  { id: 29, text: "পাতলা পায়খানা বা বমি হলে প্রতিবার পায়খানা/বমির পর পর্যাপ্ত খাবার স্যালাইন (ORS) খাবেন।" },
  { id: 30, text: "অতিরিক্ত ঘাম বা পানিশূন্যতা দেখা দিলে ডাবের পানি বা ওরাল স্যালাইন পানি পান করবেন।" },
  { id: 31, text: "ক্ষতস্থান বা কাটার জায়গায় দূষিত পানি লাগাবেন না এবং নিয়মিত পরিষ্কার ও শুকনো ড্রেসিং করে রাখবেন।" },
  { id: 32, text: "চর্মরোগ বা চুলকানি হলে ব্যক্তিগত জিনিসপত্র (তোয়ালে, বিছানা, কাপড়) পরিষ্কার রাখুন ও রোদে শুকান।" },
  { id: 33, text: "চোখের যেকোনো সমস্যায় হাত দিয়ে রগড়াবেন না এবং পরিষ্কার ঠাণ্ডা পানির ঝাপটা দিন।" },
  { id: 34, text: "দাঁতের ক্ষয়রোধে প্রতিবার খাওয়ার পর ভালো করে কুলি করুন এবং রাতে ঘুমানোর আগে দাঁত ব্রাশ করুন।" },
  { id: 35, text: "বাইরে বের হওয়ার সময় অবশ্যই মাস্ক ব্যবহার করবেন এবং ধুলাবালি ও ধোঁয়া এড়িয়ে চলবেন।" },
  { id: 36, text: "খাবার খাওয়ার আগে এবং টয়লেট ব্যবহারের পরে সাবান ও পানি দিয়ে ভালো করে হাত ধুয়ে নিবেন।" },
  { id: 37, text: "প্রস্রাবের বেগ দীর্ঘক্ষণ আটকে রাখবেন না, পর্যাপ্ত বেগ হওয়ার সাথে সাথেই মূত্রত্যাগ করুন।" },
  { id: 38, text: "গর্ভাবস্থায় মায়েরা নিয়মিত গর্ভকালীন স্বাস্থ্য পরীক্ষা (ANC Checkup) নিশ্চিত করবেন।" },
  { id: 39, text: "শিশুদের সরকারি টিকাদান কার্ড অনুযায়ী সকল প্রতিষেধক টিকা সময়মতো নিশ্চিত করুন।" },
  { id: 40, text: "কাশির সময় বা হাঁচি দেওয়ার সময় মুখে কনুই বা রুমাল ব্যবহার করুন।" }
];
